...
const Input = styled.input`
  height: 46px; padding: 10px 40px; border-radius: 12px; border: 1px solid #e5e7eb; background: #fff;
...
const LeftIcon = styled.span`
  position: absolute; inset: 0 auto 0 12px; display: grid; place-items: center; pointer-events: none; color: #64748b;
`;
const RightBtn = styled.button`
  ...
  color: #475569; cursor: pointer; &:hover { background: #f1f5f9; }
`;
...
const Submit = styled.button`
  ...
  &:hover { background: #0b1220; } &:active { transform: translateY(1px); }
...
const Secondary = styled.button`
  ...
  font-weight: 700; font-size: 14px; letter-spacing: .2px; cursor: pointer; transition: transform .04s ease, box-shadow .15s ease, background .15s ease;
  margin-top: 8px;
...
// Icons
const UserIcon = (p) => (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" {...p}><path d="M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Z" stroke="currentColor" strokeWidth="2"/><path d="M4 20c0-3.3 3.6-6 8-6s8 2.7 8 6" stroke="currentColor" strokeWidth="2"/></svg>);
const LockIcon = (p) => (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" {...p}><rect x="4" y="10" width="16" height="10" rx="2" stroke="currentColor" strokeWidth="2"/><path d="M8 10V8a4 4 0 1 1 8 0v2" stroke="currentColor" strokeWidth="2"/></svg>);
const EyeIcon = (p) => (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" {...p}><path d="M1.5 12S5 5 12 5s10.5 7 10.5 7-3.5 7-10.5 7S1.5 12 1.5 12Z" stroke="currentColor" strokeWidth="2"/><circle cx="12" cy="12" r="3.5" stroke="currentColor" strokeWidth="2"/></svg>);
const EyeOffIcon = (p) => (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" {...p}><path d="M3 3l18 18" stroke="currentColor" strokeWidth="2"/><path d="M2 12s3.5-7 10-7c2.1 0 4-.7 5.6 1.7M22 12s-3.5 7-10 7c-2.1 0-4-.7-5.6-1.7" stroke="currentColor" strokeWidth="2"/></svg>);
